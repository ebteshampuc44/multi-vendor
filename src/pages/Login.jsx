// Login.jsx - Mobile Responsive with Bottom Navigation
import { useState, useEffect } from "react";
import { Link, useNavigate } from "react-router-dom";
import { Mail, Lock, User, Eye, EyeOff, Facebook, Twitter, Github, AlertCircle, CheckCircle, Home, ShoppingCart, Heart } from "lucide-react";
...
const Login = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-pink-50 to-white flex items-center justify-center py-12 px-4 pb-24 sm:pb-12">
      <style jsx global>{`
