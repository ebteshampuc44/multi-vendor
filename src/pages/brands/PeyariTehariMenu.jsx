...
const PeyariTehariMenu = () => {
  ...
  // মেনু আইটেম ডেটা - Peyari Tehari
  const menuItems = [
    {
      id: 1,
      name: "Beef Tehari Regular",
      description: "Traditional beef tehari with aromatic rice",
      price: 280,
      image: "https://i.ibb.co.com/x7c8gJhW/beef-tehari.jpg",
      category: "tehari",
      rating: 4.7,
      prepTime: "25-35 min"
    },
    {
      id: 2,
      name: "Beef Tehari Special",
      description: "Special beef tehari with extra spices",
      price: 350,
      image: "https://i.ibb.co.com/FYyNrQD/beef-tehari-special.jpg",
      category: "tehari",
      rating: 4.8,
      prepTime: "30-40 min"
    },
    {
      id: 3,
      name: "Chicken Tehari Regular",
      description: "Chicken tehari with basmati rice",
      price: 250,
      image: "https://i.ibb.co.com/tZKDYrQ/chicken-tehari.jpg",
      category: "tehari",
      rating: 4.6,
      prepTime: "25-35 min"
    },
    {
      id: 4,
      name: "Chicken Tehari Special",
      description: "Special chicken tehari with extra chicken pieces",
      price: 320,
      image: "https://i.ibb.co.com/DLpYrVt/chicken-tehari-special.jpg",
      category: "tehari",
      rating: 4.7,
      prepTime: "30-40 min"
    },
    {
      id: 5,
      name: "Mutton Tehari Regular",
      description: "Mutton tehari with aromatic spices",
      price: 380,
      image: "https://i.ibb.co.com/DG8sPQG/mutton-tehari.jpg",
      category: "tehari",
      rating: 4.8,
      prepTime: "35-45 min"
    },
    {
      id: 6,
      name: "Mutton Tehari Special",
      description: "Special mutton tehari with tender meat",
      price: 450,
      image: "https://i.ibb.co.com/CWbQV5W/mutton-tehari-special.jpg",
      category: "tehari",
      rating: 4.9,
      prepTime: "40-50 min"
    },
    {
      id: 7,
      name: "Mixed Tehari",
      description: "Beef, chicken and mutton tehari combo",
      price: 420,
      image: "https://i.ibb.co.com/8cXjHQw/mixed-tehari.jpg",
      category: "tehari",
      rating: 4.8,
      prepTime: "35-45 min"
    },
    {
      ...
      price: 120,
      image: "https://i.ibb.co.com/RNdXZVz/plain-polao.jpg",
      category: "polao",
      rating: 4.2,
      prepTime: "15-20 min"
    },
    {
      ...
      price: 180,
      image: "https://i.ibb.co.com/5vpY7rK/chicken-roast.jpg",
      category: "roast",
      rating: 4.5,
      prepTime: "25-30 min"
    },
    {
      id: 10,
      name: "Beef Rezala",
      description: "Creamy beef rezala",
      price: 220,
      image: "https://i.ibb.co.com/4V9Hk8F/beef-rezala.jpg",
      category: "beef",
      rating: 4.6,
      prepTime: "30-40 min"
    },
    {
      ...
      price: 280,
      image: "https://i.ibb.co.com/fQFz0Hf/mutton-rezala.jpg",
      category: "mutton",
      rating: 4.7,
      prepTime: "35-45 min"
    },
    {
      ...
      price: 160,
      image: "https://i.ibb.co.com/hVYq7nT/chicken-curry.jpg",
      category: "curry",
      rating: 4.4,
      prepTime: "25-30 min"
    },
    {
      id: 13,
      name: "Beef Bhuna",
      description: "Dry beef bhuna",
      price: 200,
      image: "https://i.ibb.co.com/5L3Q3yP/beef-bhuna.jpg",
      category: "beef",
      rating: 4.5,
      prepTime: "30-35 min"
    },
    {
      ...
      price: 30,
      image: "https://i.ibb.co.com/1nGZkj8/chutney.jpg",
      category: "sides",
      rating: 4.3,
      prepTime: "5 min"
    },
    {
      ...
      price: 40,
      image: "https://i.ibb.co.com/7tq9GtR/salad.jpg",
      category: "sides",
      rating: 4.2,
      prepTime: "5 min"
    },
    {
      ...
      price: 60,
      image: "https://i.ibb.co.com/4KQ0B1W/borhani.jpg",
      category: "drinks",
      rating: 4.5,
      prepTime: "5 min"
    },
    {
      ...
      price: 50,
      image: "https://i.ibb.co.com/nnCyJmK/lassi.jpg",
      category: "drinks",
      rating: 4.4,
      prepTime: "5 min"
    },
    {
      ...
      price: 20,
      image: "https://i.ibb.co.com/m4gHJqC/water.jpg",
      category: "drinks",
      rating: 4.1,
      prepTime: "2 min"
    },
    {
      id: 19,
      name: "Tehari Combo (Beef + Borhani)",
      description: "Beef tehari with borhani",
      price: 320,
      image: "https://i.ibb.co.com/BcVJWz6/tehari-combo.jpg",
      category: "combo",
      rating: 4.8,
      prepTime: "30-40 min"
    },
    {
      id: 20,
      name: "Family Pack Tehari",
      description: "Family pack for 4-5 persons",
      price: 850,
      image: "https://i.ibb.co.com/hZzZQJq/family-pack.jpg",
      category: "tehari",
      rating: 4.9,
      prepTime: "45-55 min"
    }
  ...
  const categories = [
    ...
    { id: "combo", name: "Combo", count: menuItems.filter(item => item.category === "combo").length },
  ...
  const addToCart = (item) => {
    const cartItem = {
      ...
      restaurant: "Peyari Tehari",
      quantity: quantity[item.id] || 1,
      maxQuantity: 10,
      restaurantId: 11,
      deliveryTime: "35-45 min",
      location: "Old Dhaka, Motijheel, Lalbagh",
  ...
  const restaurantInfo = {
    ...
    minOrder: 250,
    deliveryFee: 50,
    locations: ["Old Dhaka", "Motijheel", "Lalbagh", "Gulistan"],
    cuisine: ["Bangladeshi", "Tehari", "Traditional", "Spicy"],
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-orange-50 to-white pb-20">
      ...
      <div className="container mx-auto px-3 sm:px-4 py-4 sm:py-6">
          ...
          <div className="flex flex-col sm:flex-row items-start gap-4 sm:gap-6 restaurant-info-mobile">
            <div className="flex items-center gap-3 sm:gap-4 w-full sm:w-auto">
              <div className="logo-mobile w-20 h-20 sm:w-24 sm:h-24 rounded-xl overflow-hidden border-2 sm:border-4 border-orange-100 shadow-md">
                <img 
                  src="https://i.postimg.cc/Bn9NQ691/Peyari-Tehari.jpg" 
                  alt="Peyari Tehari Logo"
                  className="w-full h-full object-cover"
                />
              </div>
              <div className="flex-1">
                <h2 className="title-mobile text-2xl sm:text-3xl font-bold text-gray-900">Peyari Tehari</h2>
                <p className="subtitle-mobile text-sm sm:text-lg text-gray-600 mt-1">Famous for Authentic Tehari</p>
              </div>
            </div>
            ...
            <div className="w-full">
              <div className="flex flex-wrap gap-2 sm:gap-4 mt-2 stats-mobile">
                <div className="stat-item-mobile flex items-center gap-1 bg-orange-50 px-3 py-2 rounded-lg">
                  ...
                  <span className="text-xs sm:text-sm text-gray-500">(800+)</span>
                </div>
                <div className="stat-item-mobile flex items-center gap-1 bg-orange-50 px-3 py-2 rounded-lg">
              ...
              <div className="special-offer-mobile bg-gradient-to-br from-orange-100 to-orange-200 rounded-lg sm:rounded-xl p-4 sm:p-5 border border-orange-200 shadow-md mt-4 sm:mt-0">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-sm sm:text-lg text-orange-700 font-medium">Free Borhani with every Tehari order!</div>
                    <div className="text-xs sm:text-sm text-gray-700 mt-1 bg-white/50 py-1 px-2 sm:px-3 rounded-full inline-block">
                      Valid on orders above <span className="font-bold">৳500</span>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div className="category-filter-mobile mb-6 sm:mb-8">
          <div className="flex items-center justify-between mb-3 sm:mb-4">
            <h3 className="text-xl sm:text-2xl font-bold text-gray-900">Tehari Menu Categories</h3>
            <button
                ...
                <button
                  ...
                  className={`category-btn px-3 py-2 sm:px-5 sm:py-3 rounded-full font-medium transition-all flex items-center gap-1 sm:gap-2 whitespace-nowrap text-sm sm:text-base ${
                    activeCategory === category.id 
                      ? 'active text-white peyari-gradient' 
        ...
        {filteredItems.length === 0 && (
          <div className="text-center py-12 sm:py-16">
            ...
            <button
              ...
              className="px-6 py-2.5 sm:px-8 sm:py-3.5 peyari-gradient text-white font-semibold rounded-full hover:shadow-xl transition-all duration-300 text-sm sm:text-lg"
            >
              View All Tehari Items
            </button>
          </div>
        )}
      </div>
      ...
      <div className="hidden lg:flex fixed bottom-8 right-8 z-40 gap-3">
        ...
        <button
          onClick={handleViewCartToast}
          className="peyari-gradient text-white font-semibold px-6 py-3.5 rounded-full shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-105 flex items-center gap-2"
        >
          <ShoppingCart className="w-5 h-5" />
...
export default PeyariTehariMenu;